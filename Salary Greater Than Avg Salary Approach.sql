...
CREATE TABLE employees (employee_id INT PRIMARY KEY, employee_name VARCHAR(100), department VARCHAR(100), salary DECIMAL(10, 2), manager_id INT);
...
SELECT E.*
FROM EMPLOYEES E
JOIN CTE ON E.SALARY > CTE.AVERAGE_SALARY;
